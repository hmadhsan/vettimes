    ...
    <div class="content">
      <div class="row">
        <el-row :gutter="10">
          <el-col :span="16" :xs="24">
            ...
            <div class="course-description" v-if="![0, 2].indexOf(info.status) > -1">
              ...
              <p>
                ...
                <span>
                  <router-link class="preview-link" :to="getPreviewLink().link" target="_blank">
          ...
          <el-col :span="8" :xs="24">
            <h2 class="course-status text-r">Status: {{ info.statusName }} <span class="course-status__info"
                v-if="statusDescription().status">{{ statusDescription().desc }}</span></h2>
